      ...
      <div className={styles.header}>
        ...
        <div className={`${styles["header__item"]} ${styles.dropdown}`}>
          ...
          <div className={styles["dropdown__content"]}>
            <span><MdMessage /> <Link href="/contact">Contact</Link></span>
            <span><MdPolicy /> <Link href="/legal">Legal</Link></span>
            <span><SiGithub /> <Link target="_blank" href="https://github.com/jelle619/bluefi.re">GitHub</Link></span>
          </div>
        </div>
      </div>
