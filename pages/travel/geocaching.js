...
export default function Geocaching() {
  ...
  return (
    <Text>
      ...
      <p>This map only displays up to the last 1000 geocaches found and is not real-time. More detailed statistics and visualisations can be found on <a href="https://project-gc.com/ProfileStats/jelle619">GC-Project</a>.</p>
